...
;(cnf (disj 'p (disj (conj 'x 'y) (conj 'r 't))))
;;(test (neg (disj 'p 'q)))
...
(define a1 (conj (disj 'b (neg 'b)) (disj 'b (neg 'a))))
...
(falsifiable-cnf? a1)
(falsifiable-cnf? a2)
(time (falsifiable-cnf? a3) (falsifiable-cnf? a3) (falsifiable-cnf? a3) (falsifiable-cnf? a3) (falsifiable-cnf? a3) (falsifiable-cnf? a3))
(falsifiable-cnf? a4)
(falsifiable-cnf? a5)
(cnf a3)
