...
class MAST extends MCTS {

	constructor(exploration, decay, epsilon) {
		super(exploration)
		this.decay = decay
...
export function Agent(exploration = 1, decay = 0.9, epsilon = 0.4) {
	return new MAST(exploration, decay, epsilon)
}